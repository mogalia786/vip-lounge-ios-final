...
import '../../../../core/widgets/rating_utils.dart';
...
class _StaffManagementScreenState extends State<StaffManagementScreen> {
  // Role filter removed per user request; show all staff regardless of role
  @override
  void initState() {
    super.initState();
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FutureBuilder<double?>(
                        future: fetchAverageRatingForStaff(staffId: staffId),
                        builder: (context, snapshot) {
                          ...
                          return FutureBuilder<QuerySnapshot>(
                            future: FirebaseFirestore.instance.collection('ratings').where('staffId', isEqualTo: staffId).get(),
