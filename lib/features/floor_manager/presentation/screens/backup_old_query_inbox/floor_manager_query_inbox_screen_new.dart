...
class FloorManagerQueryInboxScreen extends StatefulWidget {
  ...
  @override
  _FloorManagerQueryInboxScreenState createState() => _FloorManagerQueryInboxScreenState();
}
                      ...
                      children: [
                        ...
                        if (assignedToEmail.isNotEmpty) ...[
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: 12,
                              color: isOverdue ? Colors.orange.shade800 : Colors.grey.shade600,
                            ),
                          ),
                        ],
                      ],
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          if (query['assignedToName'] == null || assignedToEmail.isEmpty) ...[
            TextButton(
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => AssignStaffToQueryScreen(query: query),
                  ),
