            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    (conversation['ministerName'] as String? ?? 'U').substring(0, 1).toUpperCase(),
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          // Sender prefix
                          Text(
                            (conversation['latestMessageSender'] == 'Floor Manager' || 
                             conversation['latestMessageSender'] == _userId)
                              ? 'You: ' 
                              : '${conversation['ministerName'] ?? ''}: ',
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 14,
