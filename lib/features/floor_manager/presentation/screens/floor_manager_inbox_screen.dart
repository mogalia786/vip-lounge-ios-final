...
class FloorManagerInboxScreen extends StatefulWidget {
  final Map<String, dynamic>? chatParams;

  const FloorManagerInboxScreen({Key? key, this.chatParams}) : super(key: key);

  @override
  _FloorManagerInboxScreenState createState() => _FloorManagerInboxScreenState();
}

class _FloorManagerInboxScreenState extends State<FloorManagerInboxScreen> with TickerProviderStateMixin {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Card(
              ...
              color: hasUnread ? Colors.white : Colors.grey[50],
              child: ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'From: ${appointment['senderName'] ?? 'Minister'}',
                      style: TextStyle(
                        fontSize: 12,
  ...
  Widget _buildAllMessagesTab(String userId) {
    return StreamBuilder<List<ChatMessage>>(
      ...
      builder: (context, snapshot) {
        ...
        // Get messages and sort by timestamp descending (latest first)
