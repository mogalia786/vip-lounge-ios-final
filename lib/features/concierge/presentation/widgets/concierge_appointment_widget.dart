...
class _ConciergeAppointmentWidgetState extends State<ConciergeAppointmentWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final hasStarted = widget.appointment['conciergeSessionStarted'] == true && !isCompleted;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                if (isCompleted)
                  ...
                  if (!hasStarted && widget.onStartSession != null)
                    ElevatedButton(
                      onPressed: widget.disableStartSession ? null : widget.onStartSession,
                      child: const Text('Start Session'),
                    ),
                  if (hasStarted && widget.onEndSession != null)
                    ElevatedButton(
            ...
            if ((widget.appointment['conciergeNotes'] ?? '').isNotEmpty)
              Padding(
                padding: const EdgeInsets.only(top: 8.0),
                child: Text(
                  'Notes: ${widget.appointment['conciergeNotes']}',
